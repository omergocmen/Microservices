...
export default function CreateCourse() {
  ...
  const onSubmit = (data) => {
    const newCourse = {
      ...
      pictureUrl: "https://miro.medium.com/max/1400/1*L3jeQoxqt3jKNcgJyOPOqA.png",
      name: data.name,
  ...
  return (
    <div className="w-3/5 m-auto h-screen min-w-[400px]">
      <div className="bg-white rounded-lg mt-40">
        <h1 className="text-3xl m-5">Kurs Ekle</h1>
